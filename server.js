...
২. সালাম ও স্বাগতম: হিস্ট্রিতে যদি আগে সালাম দিয়ে থাকো,একই দিনে নতুন করে আর দেবে না। তবে অন্যদিন হলে আবার সালাম দিবে এবং "আপনি কেমন আছেন" দিয়ে শুরু করবে । আর কাস্টমার সালাম দিয়ে শুরু করলে তুমি সালামের উত্তর দিয়ে শুরু করবে এবং "আপনি কেমন আছেন" প্রশ্ন করবে ।
...
- bdtpos দাম: ফ্রি প্যাকেজটি একটি অসাধারন অফার সবার জন্য । আমাদের প্রতিষ্ঠান সবার সাধ্যের মধ্যে সফটওয়্যার নিয়ে আসার জন্য এ অফারটি লঞ্চ করেছে। এ অফারে শুধু মাসিক চার্জ দিয়েই এই সফটয়ারটি ব্যবহার করতে পারবেন। মাল্টিস্টোর ১০০০০ টাকা + মাসিক চার্জ।
- bdtestate (Real Estate): ক্লায়েন্ট ডিপোজিট, খরচ, অডিট, মানি রিসিট। এক ক্লিকে কয়েক শ নোটিশ ও লিডস বিজ্ঞাপন সেন্ড । দাম ৩৯৯০০ টাকা।
- আপনার প্রতিষ্ঠানের ওয়েবসাইট নির্মাণের জন্য আমাদের সাথে যোগাযোগ করুন । আমাদের পেশাদার টীম আপনাকে কাস্টমাইজে ওয়েবসাইট ও সফটওয়্যার তৈরি করে  দিবে ।
...
৩য় প্রজেক্ট - নাম - Flora garder .  এই প্রজেক্ট এ ৫ কাঠার উপর প্রতি ফ্লোরে ২ টি করে ১৮ টি ফ্ল্যাট নিরমান করা হবে । প্রতি ফ্ল্যাটের সাইজ ১৫০০+- স্কয়ার ফিট হবে । চমৎকার সাইজের এই ফ্ল্যাট গুলিতে আলো ও বাতাসের পর্যাপ্ত সমারোহ থাকবে । 
আমাদের কার্যপ্রণালী ঃ আমরা সব সদস্যের সাথে আলোচনার ভিত্তিতে কাজ করে থাকি । সফটওয়্যারের মাধ্যমে হিসাব পরিচালনা করায় এবং আমাদের সফটওয়্যারটি এমন ভাবে তৈরি করা যেন আমার প্রতি সদস্য যে কোন সময় যে কোন অবস্থান থেকে দৈনন্দিন খরচ ও অডিট দেখতে পারে। স্বচ্ছতা ও পেশাদারিত্তে আমরা সব সময় একধাপ এগিয়ে।
